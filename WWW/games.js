...
window.GAMES = [
  ...
  { key:"quick", icon:"quick", subs:[            // 1~5m
    { key:"puzzle", icon:"puzzle", games:[ {key:"blockfit", id:5, dsp_dsc_idx:"blockfit890", cfg:"8,90", icon:"blockfit90", resume:true} ] },
  ...
  { key:"deep", icon:"deep", subs:[              // 5m+
    { key:"puzzle", icon:"puzzle", games:[ {key:"blockfit", id:6, dsp_dsc_idx:"blockfit8inf", cfg:"8,0", icon:"blockfitinf", resume:true} ] },
