...
window.GAMES = [
  ...
  { key:"quick", icon:"quick", subs:[            // 1~5m
    { key:"puzzle", icon:"puzzle", games:[ {key:"mathdoku", id:2, inf:"mathdoku54", cfg:"5,4", icon:"mathdoku5"} ] },
  ...
  { key:"deep", icon:"deep", subs:[              // 5m+
    { key:"puzzle", icon:"puzzle", games:[ {key:"mathdoku", id:21, inf:"mathdoku94", cfg:"9,4", icon:"mathdoku9"} ] },
